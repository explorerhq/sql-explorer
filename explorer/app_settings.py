...
EXPLORER_SQL_BLACKLIST = getattr(settings, 'EXPLORER_SQL_BLACKLIST', ('ALTER', 'RENAME ', 'DROP', 'TRUNCATE', 'INSERT INTO', 'UPDATE', 'REPLACE', 'DELETE', "ALTER", "CREATE", "CURSOR", "EXEC", "EXECUTE", "FETCH", "insert", "KILL", "OPEN", "SYS", "SYSOBJECTS", "SYSCOLUMNS"))
...
EXPLORER_PARAM_TOKEN = getattr(settings, 'EXPLORER_PARAM_TOKEN', "$$")